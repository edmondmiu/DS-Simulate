...
class ConfigValidator {
   ...
   */
  public validateCurrentConfig(options: ValidationOptions = {}): boolean {
   ...
   */
  public testConfigLoader(): boolean {
    try {
   ...
   */
  public testInvalidConfigurations(): boolean {
    ...
    for (const testCase of testCases) {
      ...
      const hasExpectedErrors = testCase.expectedErrors.some(expectedField => 
        errorFields.some(errorField => errorField.includes(expectedField))
      );
   ...
   */
  public runAllTests(options: ValidationOptions = {}): boolean {
