...
class SplitScript {
    ...
    readTokenSource() {
        ...
        try {
            ...
            const consolidatedTokens = JSON.parse(content);
    ...
    validateTokenSourceStructure(consolidatedTokens) {
    ...
    splitTokenSets(consolidatedTokens) {
    ...
    writeTokenSetFile(tokenSetName, tokenData) {
    ...
    generateMetadata(consolidatedTokens) {
    ...
    generateThemes(consolidatedTokens) {
    ...
    generateDefaultTokenSetConfig(tokenSetNames) {
        const config = {};
