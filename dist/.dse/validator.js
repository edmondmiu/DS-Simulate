 ...
 */
export function validateColorLibraryConfig(config) {
    const errors = [];
    const warnings = [];
    ...
    const colorLibrary = configObj.colorLibrary;
 ...
 */
export function validateColorLibraryFile(filePath) {
    try {
 ...
 */
function validateColorSpace(colorLibrary, errors) {
 ...
 */
function validateLightnessRange(colorLibrary, errors, warnings) {
    ...
    const range = colorLibrary.lightnessRange;
 ...
 */
function validateChromaRange(colorLibrary, errors, warnings) {
    ...
    const range = colorLibrary.chromaRange;
 ...
 */
function validateAccessibilityThresholds(colorLibrary, errors, warnings) {
    ...
    const thresholds = colorLibrary.accessibilityThresholds;
 ...
 */
function validateConversionOptions(colorLibrary, errors) {
    ...
    const options = colorLibrary.conversionOptions;
 ...
 */
function validateBrandSpecific(brandSpecific, errors, _warnings) {
 ...
 */
function validateColorGeneration(colorGeneration, errors, warnings) {
