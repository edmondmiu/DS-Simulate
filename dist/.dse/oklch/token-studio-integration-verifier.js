...
export class TokenStudioVerifier {
     ...
     */
    static testConsolidateWorkflow() {
    ...
    static testBrandSwitching() {
        return this.executeTest('Brand Switching', () => {
            try {
                ...
                const foundBrandFamilies = [];
                const missingBrandFamilies = [];
    ...
    static testColorValidation() {
        return this.executeTest('Color Validation & Token Studio Compatibility', () => {
            try {
                ...
                let invalidColors = [];
                let tokenStudioStructureIssues = [];
                if (!coreTokens['Color Ramp']) {
                    return {
                        success: false,
     ...
     */
    static verifyTokenStudioIntegration() {
     ...
     */
    static generateTokenStudioReport() {
...
//# sourceMappingURL=token-studio-integration-verifier.js.map