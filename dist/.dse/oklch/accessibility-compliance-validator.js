...
export class AccessibilityValidator {
     ...
     */
    static categorizeColors(tokens) {
     ...
     */
    static testColorCombinations(foregroundColors, backgroundColors, usageContext) {
        const results = [];
     ...
     */
    static testBrandAccessibility(tokens) {
        const colorRamp = tokens['Color Ramp'];
        const results = [];
     ...
     */
    static testMultiBrandAccessibility(tokens) {
        const colorRamp = tokens['Color Ramp'];
        const results = [];
    ...
    static validateAccessibility() {
        ...
        const textResults = this.testColorCombinations(colorsByUsage.text, colorsByUsage.backgrounds, 'text');
        ...
        const interactiveResults = this.testColorCombinations(colorsByUsage.interactive, colorsByUsage.backgrounds, 'interactive');
        ...
        const semanticResults = this.testColorCombinations(colorsByUsage.semantic, colorsByUsage.backgrounds, 'semantic');
    ...
    static generateAccessibilityReport() {
        ...
        if (report.violations.length > 0) {
            ...
            report.violations.slice(0, 10).forEach(violation => {
...
//# sourceMappingURL=accessibility-compliance-validator.js.map