...
import { DEFAULT_COLOR_LIBRARY_CONFIG } from './schema.js';
...
export class DSEConfigLoader {
    static instance;
    colorLibraryConfig = null;
    dseDirectory;
    constructor(dseDirectory = '.dse') {
     ...
     */
    static getInstance(dseDirectory = '.dse') {
    ...
    loadColorLibraryConfig() {
        ...
        try {
            ...
            this.colorLibraryConfig = parsedConfig;
 ...
 * @returns DSEConfigLoader instance
 */
export function getDSEConfig(dseDirectory) {
