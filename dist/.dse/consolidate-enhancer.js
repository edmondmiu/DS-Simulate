...
export class ConsolidateEnhancer {
     ...
     */
    processTokens(consolidatedTokens, options) {
        if (!options.enabled) {
            if (options.verbose) {
        ...
        for (const [tokenSetName, tokenData] of Object.entries(consolidatedTokens)) {
            ...
            enhancedTokens[tokenSetName] = this.processTokenSet(tokenData, tokenSetName, options);
        }
     ...
     */
    processTokenSet(tokenData, tokenSetName, options) {
     ...
     */
    processColorToken(token, tokenSetName, options) {
...
//# sourceMappingURL=consolidate-enhancer.js.map